...
class LoanBrokerStack : Stack
{
        ...
        : base(scope, id, props)
    {
        ...
        _ = new NServiceBusEndpointResource(new EndpointDetails("EmailSender"), this, "LoanBroker.EmailSender");
        ...
        // temporary remove grafana for making the deploy faster
        ...
        ApplicationContainer("EmailSender", cluster);
    }
    ...
    private void ApplicationContainer(string applicationName, Cluster cluster)
    {
        ...
        FargateTaskDefinition taskDefinition = new FargateTaskDefinition(this, applicationName + "TaskDef",
